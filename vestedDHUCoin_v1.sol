pragma solidity ^0.4.21;
  ...
  contract Token{
   ...
   contract grantVestedDHU is SafeMath{

  	uint256 public tgeEndBlock;
  	address public beneficiary;

    // withdraw first token supply after TGE
    ...
    bool private eighthWithdrawalFinished = false;
  	...
  	function grantVestedDHU(address _token, uint256 tgeEndBlockInput){
      	require(_token != address(0));
      	beneficiary = msg.sender;
      	tgeEndBlock = tgeEndBlockInput;
  	...
  	function changeTgeEndBlock(uint256 newTgeEndBlock){
      	require(msg.sender == beneficiary);
    ...
    // initial_withdrawal releases 60% of tokens
  	function initial_withdrawal(uint256 balance) private atPhase(Phases.initialTeamWithdrawal){
      	firstTeamWithdrawal = now + 5 minutes;
      	secondTeamWithdrawal = firstTeamWithdrawal + 5 minutes;
      	thirdTeamWithdrawal = secondTeamWithdrawal + 5 minutes;
      	fourthTeamWithdrawal = thirdTeamWithdrawal + 5 minutes;
      	fifthTeamWithdrawal = fourthTeamWithdrawal + 5 minutes;
      	sixthTeamWithdrawal = fifthTeamWithdrawal + 5 minutes;
      	seventhTeamWithdrawal = sixthTeamWithdrawal + 5 minutes;
      	eighthTeamWithdrawal = seventhTeamWithdrawal + 5 minutes;
  	...
  	function withdrawOtherDHU(address _token) external{
      	require(msg.sender == beneficiary);
      	require(_token != address(0));
